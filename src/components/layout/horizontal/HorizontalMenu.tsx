...
const showcase = process.env.NEXT_PUBLIC_SHOWCASE === 'true'
  ...
  return (
    ...
    >
      ...
      >
        ...
        <SubMenu label='Projects' icon={<i className='tabler-folders' />}>
          <MenuItem href={`/${locale}/projects`}>Projects</MenuItem>
        </SubMenu>
        <SubMenu label='Clients' icon={<i className='tabler-users-group' />}>
          <MenuItem href={`/${locale}/clients`}>Clients</MenuItem>
        </SubMenu>
        <SubMenu label='Tasks' icon={<i className='tabler-checklist' />}>
          <MenuItem href={`/${locale}/tasks`}>Tasks</MenuItem>
        </SubMenu>
        <SubMenu label='Documents' icon={<i className='tabler-file-text' />}>
          <MenuItem href={`/${locale}/documents`}>Documents</MenuItem>
        </SubMenu>
        <SubMenu label='Financials' icon={<i className='tabler-currency-euro' />}>
          <MenuItem href={`/${locale}/financials`}>Financials</MenuItem>
        </SubMenu>
        {showcase && (
